...
- [x] 구입 금액 입력  
  - [x] 1000원 단위로 나누어 떨어지는지 체크. 만일 나누어 떨어지지 않는 경우, 예외 처리   
  - [x] 구입 금액만큼 발행한 로또 수량 및 번호를 출력한다. 로또 번호는 오름차순으로 정렬하여 보여준다.
- [ ] 당첨 번호 및 보너스 번호 입력
  - [x] 당첨 번호 : 6개의 숫자가 쉼표를 기준으로 구분된 형태로 입력
  - [x] 보너스 번호 : 1개의 단일 숫자 입력
- [ ] 당첨 통계 출력
