...
- [x] 당첨 통계 출력
  - [x] 3,4,5개, 5개와 보너스, 그리고 6개일치, 총 5개 종류의 당첨 내역 출력
  - [x] 수익률 출력
    - [x] ((당첨 금액) / (구입 금액)) * 100 을 계산한 값을 소수점 둘째자리에서 반올림해준 후 출력
---  
...
- [x] 구입 금액 입력 테스트
  - [x] 정수형 숫자를 입력하지 않는 경우 예외 발생
  - [x] 0 이하의 정수를 입력하는 경우 예외 발생
  - [x] 1000원 단위로 나누어 떨어지지 않는 경우 예외 발생
  
- [ ] 당첨 번호 및 보너스 번호 입력 테스트
  - [x] 당첨 번호  
    - [x] 정수형 숫자를 입력하지 않는 경우 예외 발생
    - [x] 6개의 숫자가 쉼표를 기준으로 구분된 형태가 아닌 경우 예외 발생
    - [x] 숫자가 6개가 아닌 경우 예외 발생
    - [x] 1부터 45 사이의 숫자가 아닌 경우 예외 발생
    - [x] 숫자가 서로 중복될 경우 예외 발생
  - [ ] 보너스 번호  
    - [ ] 정수형 숫자를 입력하지 않는 경우 예외 발생
    - [ ] 1부터 45 사이의 숫자가 아닌 경우 예외 발생
    - [ ] 당첨 번호와 일치하는 숫자일 경우 예외 발생